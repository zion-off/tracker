  ...
  return (
    <main className="flex flex-col justify-center items-center gap-5 absolute inset-0">
      ...
      >
        <button
          type="submit"
          className="px-3 shadow-lg inline-flex w-full justify-center rounded-md py-2 text-gray-900 border-2 border-1  bg-gray-50 sm:mt-0 sm:w-auto text-xs"
        >
          <svg
            aria-label="Google icon"
            className="amplify-icon w-5 h-4 mr-2"
            viewBox="0 0 256 262"
            xmlns="http://www.w3.org/2000/svg"
